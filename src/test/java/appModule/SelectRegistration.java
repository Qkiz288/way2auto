...
public class SelectRegistration {
  public static void execute(WebDriver driver) {
    ...
    while (attemptsOnFindingDropdownElement < 20) {
      try {
        ...
        Demo_Page.RegistrationSection.box_Registration(driver).click();
        break;
  ...
  private static void waitForElementToBeVisible(WebDriver driver) {
    new WebDriverWait(driver, 30).until(ExpectedConditions.visibilityOf(Demo_Page.RegistrationSection.box_Registration(driver)));
  }
}
