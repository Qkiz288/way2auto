...
public class SelectDatepicker {
  public static void execute(WebDriver driver) {
    ...
    while (attemptsOnFindingDraggableElement < 20) {
      try {
        ...
        Demo_Page.WidgetSection.box_Datepicker(driver).click();
        break;
  ...
  private static void waitForElementToBeVisible(WebDriver driver) {
    new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(Demo_Page.WidgetSection.box_Datepicker(driver)));
  }
}
